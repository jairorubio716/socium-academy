        ...
        <CardContent>
          <form onSubmit={manejarLogin} className="space-y-4">
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 border-gray-300 dark:border-gray-500 dark:bg-gray-800/50 hover:bg-gray-50 dark:hover:bg-gray-700/70 transition-colors flex items-center justify-center gap-2 text-gray-700 dark:text-gray-200"
